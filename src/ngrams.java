/*
    ...
    Date Last Modified: 09 Jan 2018
*/
...
public class ngrams {
    ...
    // violates good programming practice by accessing
    // a global variable (inputFileNames)
    ...
    public static void main(String[] args) {
        ...
        // collects file names and write them to InputFileNames
        ...
        // counts to an output file (character count writer)
        ...
        try {
            ...
            System.err.println("Unable to open " + args[1] +
                    " for writing words");
        ...
        for (int index = 0; index < fileCount; index++) {
            ...
            try {
                ...
                while ((line = br.readLine()) != null) {
                    // process the line by extracting words
                    // using the wordPattern
                    wordMatcher = wordPattern.matcher(line);

                    // process one word at a time
                    while (wordMatcher.find()) {
                        // extract the word
                        word = line.substring(wordMatcher.start(),
                                wordMatcher.end());
                        // System.out.println(word);

                        // convert the word to lower-case,
                        // and write to word file
                ...
                System.err.println("File " + inputFileNames[index]
        ...
        try {
            ...
            System.err.println("Unable to open " + args[2] +
        ...
        for (int index = 0; index < charCountArray.length; index++) {
            // Writing character occurrences
            ccWriter.println(alphabet.charAt(index) + "\t" +
